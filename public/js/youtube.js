...
$.get("/api/song/videoId").then((data) => {
  ...
  var YouTubePlayer = {
    ...
    currentlyPlaying: function() {
      ...
      console.info(
        "Current Track id",
        YouTubePlayer.videos[YouTubePlayer.current]
      );
  ...
  var YouTubePlayer2 = {
    ...
    currentlyPlaying2: function() {
      console.info(
        "Current2 Track id",
        YouTubePlayer2.videos2[YouTubePlayer2.current2]
      );
    ...
    playNext2: function() {
      ...
      if (YouTubePlayer2.player2) {
        YouTubePlayer2.player2.loadVideoById(
          YouTubePlayer2.currentlyPlaying2()
        );
      } else {
  ...
  var YouTubePlayer3 = {
    ...
    currentlyPlaying3: function() {
      console.info(
        "Current3 Track id",
        YouTubePlayer3.videos3[YouTubePlayer3.current3]
      );
    ...
    playNext3: function() {
      ...
      if (YouTubePlayer3.player3) {
        YouTubePlayer3.player3.loadVideoById(
          YouTubePlayer3.currentlyPlaying3()
        );
      } else {
